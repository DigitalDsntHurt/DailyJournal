...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post journal_entries_url, params: { journal_entry: { entry: @journal_entry.entry, entry_type: @journal_entry.entry_type, prompt: @journal_entry.prompt } }
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { entry: @journal_entry.entry, entry_type: @journal_entry.entry_type, prompt: @journal_entry.prompt } }
