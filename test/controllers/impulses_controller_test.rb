...
class ImpulsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create impulse" do
    assert_difference('Impulse.count') do
      post impulses_url, params: { impulse: { name: @impulse.name, resisted: @impulse.resisted } }
    end
  ...
  test "should update impulse" do
    patch impulse_url(@impulse), params: { impulse: { name: @impulse.name, resisted: @impulse.resisted } }
