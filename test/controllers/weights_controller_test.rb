...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { notes: @weight.notes, weighed_at: @weight.weighed_at, weight: @weight.weight } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { notes: @weight.notes, weighed_at: @weight.weighed_at, weight: @weight.weight } }
