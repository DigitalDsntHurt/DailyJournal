class EveningRitualsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @evening_ritual.save
        format.html { redirect_to :back, notice: 'Evening ritual was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @evening_ritual.update(evening_ritual_params)
        format.html { redirect_to :back, notice: 'Evening ritual was successfully updated.' }
  ...
  private
    ...
    def evening_ritual_params
      params.require(:evening_ritual).permit(:day, :core, :stretch, :brush, :read, :journal)
    end
end
